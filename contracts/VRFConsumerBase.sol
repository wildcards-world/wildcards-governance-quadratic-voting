...
abstract contract VRFConsumerBase is VRFRequestIDBase {
    ...
    function psuedoConstructor(address _vrfCoordinator, address _link) public {
        require(vrfCoordinator == address(0), "Can only be intialized once");
        require(_vrfCoordinator != address(0), "Cannot set to null address");
        vrfCoordinator = _vrfCoordinator;
        LINK = LinkTokenInterface(_link);
    }
